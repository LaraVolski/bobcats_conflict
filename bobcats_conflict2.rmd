...
ggplot(subset.rai, aes(x = Season, y = Bobcat_RAI, fill = Season)) +
  ...
  labs(x ="Season", y = "Relative Bobcat Activity") +
  theme_bw()
...
test <- read.csv("subset.rai.fire.year.csv")

  ggplot(test, aes(x = Sheep, y = Bobcat_RAI, fill = Sheep)) +
  geom_boxplot() +
  theme_bw() +
  theme(legend.position = "none") +
  ...
  scale_fill_manual(values=c("cadetblue4", "orange1")) 
  ggsave(file = "bobcat.rai.by.fire.and.sheep2.png")
